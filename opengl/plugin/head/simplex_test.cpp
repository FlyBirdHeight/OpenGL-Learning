...
float SimplexNoiseTest::noise(float x, float y, float z) {
...
float SimplexNoiseTest::fractal(size_t octaves, float x, float y, float z) const {
    float output = 0.f;
    float denom  = 0.f;
    ...
    for (size_t i = 0; i < octaves; i++) {
        output += (amplitude * (this->noise(x * frequency, y * frequency, z * frequency)));
        denom += amplitude;
